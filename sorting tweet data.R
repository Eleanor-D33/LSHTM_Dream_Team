# load file 
setwd("/Users/eleanordavies/Desktop/HDS_Content/Term_2/Data_Challenge/Final_Zip/Tweet_Data")
...
API_suicide_clean <- read.csv("API_suicide_clean.csv")
...
API_suicide_clean$label <- "API_suicide_clean"
...
API_suicide_clean$Date <- as.Date(API_suicide_clean$Date)
...
write.csv(mw_anx_clean, "Labelled/mw_anx_clean.csv")
...
write.csv(API_suicide_clean, "Labelled/API_suicide_clean.csv")

# set working directory to folder containing all csv files to be merged 
wd <- ("/Users/eleanordavies/Desktop/HDS_Content/Term_2/Data_Challenge/Final_Zip/Tweet_Data/Labelled")
...
save(files ,file = "/Users/eleanordavies/Desktop/HDS_Content/Term_2/Data_Challenge/Final_Zip/Tweet_Data/tweets_total_clean.RData")
